function getquestions(str)
{
 ...
 if(str!="Select Subject")
 {
  ...
  req.open("post","http://localhost/Core-test-portal/public/getquestions.php",true);
...
function validateform()
{
 ...
 var check_count=0;
  ...
  for(i=0;i<chk.length;i++)
   if(chk[i].checked) 
     check_count++;
  if(check_count==0 ||check_count>10)
   flag=false;
if(flag==false)   
{
document.getElementById("errormsg").style.color="red";
  document.getElementById("errormsg").innerHTML="Either you have selected none or more than 10 questions..";
 }
 return(flag);
}